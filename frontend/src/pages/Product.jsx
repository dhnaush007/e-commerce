...
import RelatedProdects from '../components/RelatedProdects';
  ...
  return productsData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      {/*--------------------- Products Data---------------- */}
         ...
         {/* -----------------------Products Images------------------- */}
         <dir className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
         ...
         <div className='flex-1 '>
            ...
            <hr  className='mt-8 sm:w-4/5' />
             <dir className='text-sm text-gray-500 flex flex-col gap-1'>
              <p>100% Original Product</p>
              <p>Cash on devlivery id available on this Product</p>
              <p>Easy return and exchange policy within 7 days.</p>
             </dir>
         </div>

         </div>
         {/* ------------------------ Descriton & Review Section-----------  */}
         <div className='mt-20'>
          <div className='flex '>
                <b className='border px-5 py-3 text-sm' >Descrtion</b>
                <p className='border px-5 py-3 text-sm'>Reviews (122)</p>
          </div>
          <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea saepe nihil architecto quod inventore soluta eius omnis possimus consequuntur laborum doloribus ad, molestias provident quasi, temporibus nisi nemo animi laboriosam.</p>
     ...
     <RelatedProdects category={productsData.category} subCategory={productsData.subCategory}/>
